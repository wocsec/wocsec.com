...
switch (currentPage) {
  default:
    ...
    break;
  case "podcasts":
    var jsonFilename = "json/podcasts.json";
    var navName = "podcasts";
    var showCount = true;
    break;
  case "youtube":
    var jsonFilename = "json/youtube.json";
    var navName = "youtube";
    var showCount = true;
    break;
  case "sites":
    var jsonFilename = "json/sites.json";
    var navName = "sites";
    var showCount = true;
    break;
  case "books":
    var jsonFilename = "json/books.json";
    var navName = "books";
    var showCount = true;
    break;
  case "disclaimer":
